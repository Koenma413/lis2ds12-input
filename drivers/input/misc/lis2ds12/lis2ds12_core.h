...
#ifndef DRIVERS_INPUT_MISC_LIS2DS12_CORE_H_
#define DRIVERS_INPUT_MISC_LIS2DS12_CORE_H_
...
#define LIS2DS12_RX_MAX_LENGTH		(500)
#define LIS2DS12_TX_MAX_LENGTH		(500)
...
struct lis2ds12_transfer_function {
	int (*write) (struct lis2ds12_data *cdata, u8 reg_addr, int len, u8 *data,
								bool b_lock);
	int (*read) (struct lis2ds12_data *cdata, u8 reg_addr, int len, u8 *data,
								bool b_lock);
};
...
struct lis2ds12_data {
	...
	struct work_struct input_work;
	struct device *dev;
	struct lis2ds12_sensor_data sensors[LIS2DS12_SENSORS_NUMB];
...
#endif /* DRIVERS_INPUT_MISC_LIS2DS12_CORE_H_ */
